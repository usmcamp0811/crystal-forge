...
- [ ] #7 Build evaluation system and policy deep links integrate with URL-backed navigation focus without leaving stale focus on later navigation
...
- [ ] #10 Focused model navigation and interaction tests plus the authoritative web-ui check pass with exact-target fallback expand and restore focus keyboard reduced-motion light dark and narrow assertions and screenshots
- [ ] #11 The shared tray expansion and focus-restoration contract is reusable by the scan-log tray tracked in TASK-326.2 without duplicating tray behavior
<!-- AC:END -->
