...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Build evaluation flake CVE scan policy compliance bundle and compliance evidence trays expose a consistent Expand and Restore control that widens content without covering classification banners or losing the selected item
...
- [ ] #7 Build evaluation system policy and scan deep links integrate with URL-backed navigation focus without leaving stale focus on later navigation
...
- [ ] #10 Focused model navigation and interaction tests plus the authoritative web-ui check pass with exact-target fallback expand and restore focus keyboard reduced-motion light dark narrow and scan-log assertions and screenshots
<!-- AC:END -->
