...
<!-- SECTION:NOTES:BEGIN -->
LOCK: released (merged to dev as commit 1459def7)MR: https://gitlab.com/crystal-forge/crystal-forge/-/merge_requests/205Worktree cleaned up.
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Implemented Builds queue controls: Stop/cancel API with cancelling state, Run Next correctness, action availability (Restart only for terminal states), queue depth fix, human-readable duration formatting, and table mode toggle. Merged as commit 1459def7 into dev. Worktree removed post-merge.
