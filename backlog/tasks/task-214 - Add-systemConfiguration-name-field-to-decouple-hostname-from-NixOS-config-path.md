...
Absorbed into TASK-221 — all system_configuration_name work (DB column, migration, API, build path, frontend) will be delivered as part of that task.
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Cancelled/absorbed — all scope from this task has been merged into TASK-221 (flake credentials, build scope, system modal UI). No standalone implementation needed.
