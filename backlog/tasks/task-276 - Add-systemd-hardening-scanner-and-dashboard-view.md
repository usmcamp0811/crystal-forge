...
<!-- SECTION:NOTES:BEGIN -->
Additional fit pass pushed in commit 20a939a9: widened modal shell, increased viewport headroom, reduced internal spacing, and bounded directive/history list heights so controls remain visible.
<!-- SECTION:NOTES:END -->
