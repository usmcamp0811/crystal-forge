    ...
    def succeed(self, command: str) -> str:
        ...
        if command.startswith('systemctl status'):
            ...
            if 'postgresql.service' in command:
                ...
                return self._check_process_running('server', 'crystal-forge')  # Same process
            else:
        ...
        elif command.startswith('nix ') or command.startswith('git ') or command.startswith('curl '):
...
class DevShellLogger:
    ...
    def capture_command_output(self, vm: DevShellVM, command: str, filename: str, description: str) -> str:
    ...
    def database_query(self, vm: DevShellVM, db_name: str, query: str, output_file: str) -> str:
