...
fn main() {
    ...
    let snapshot = XccdfBundleExport {
        ...
        groups: vec![XccdfGroupExport {
            generated_id: "xccdf_crystalforge_group_fixture".into(),
            source_id: Some("V-268078".into()),
            title: "Fixture Group".into(),
            description: Some("Preserved source group".into()),
            order: 1,
            children: vec![],
            policies: vec![policy_version_id],
        }],
