...
CREATE TABLE user_notification_preferences (
    ...
    deploy_failures_in_app_enabled_at TIMESTAMPTZ DEFAULT NOW(),
    build_failures_in_app_enabled_at TIMESTAMPTZ DEFAULT NOW(),
    critical_cves_in_app_enabled_at TIMESTAMPTZ DEFAULT NOW(),
    policy_violations_in_app_enabled_at TIMESTAMPTZ DEFAULT NOW(),
    heartbeat_lost_in_app_enabled_at TIMESTAMPTZ,
