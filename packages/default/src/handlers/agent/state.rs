...
use crate::queries::system_events::{lock_observed_system_state_by_hostname_tx, record_report_events_tx};
...
pub async fn update(
    ...
    update_with_lookup_and_insert(headers, body, &pool, |payload, version_compatible| {
        ...
        Box::pin(async move {
            ...
            let previous_observed = lock_observed_system_state_by_hostname_tx(&mut tx, &payload.hostname).await?;
