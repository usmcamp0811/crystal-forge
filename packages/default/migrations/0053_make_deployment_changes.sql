...
CREATE INDEX idx_systems_desired_derivation ON public.systems (desired_derivation);
...
-- Migration 5: Add foreign key constraint for desired_derivation (optional)
-- This ensures desired_derivation references a valid derivation path
...
ALTER TABLE public.systems
    ADD CONSTRAINT fk_systems_desired_derivation FOREIGN KEY (desired_derivation) REFERENCES public.derivations (derivation_path);
