...
pub fn SystemCard(
    ...
    rsx! {
        div {
            ...
            Link {
                to: Route::SystemDetailView { id: system.id.to_string(), tab: String::new(), poam: String::new(), config_mode: String::new(), revision: String::new(), generation: String::new(), deploy_generation: String::new() },
                class: "block",
                div {
