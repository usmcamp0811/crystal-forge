                ...
                div {
                    ...
                    div {
                        ...
                        if !show_onboarding_callouts {
                            div {
                                ...
                                ol {
                                    ...
                                    li {
                                        "Copy the builder public key from that host, for example "
                        ...
                        p {
                            ...
                            "Paste the public half of the keypair generated by the builder host, or generate a pair here and install the private key on that host."
                        }
