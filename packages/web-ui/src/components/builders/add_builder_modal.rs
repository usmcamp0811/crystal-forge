                    ...
                    div {
                        ...
                        if !show_onboarding_callouts {
                            div {
                                ...
                                style: "font-size:11.5px; display:block; margin-bottom:12px;",
                                div {
                                ...
                                ol {
                                    ...
                                    li {
                                        "Copy the base64 builder public key from that host, for example "
                                        span { class: "mono", style: "font-size:10.5px;", "cat /var/lib/crystal-forge/builder-api.key.pub" }
                                        "."
                                    }
                                    li { "Paste it below to recognize the worker on its next check-in." }
                                }
                            }
                        }
                        div {
                        ...
                        p {
                            ...
                            "Paste the base64 public half of the keypair generated by the builder host, or generate a pair here and install the private key on that host."
                        }
