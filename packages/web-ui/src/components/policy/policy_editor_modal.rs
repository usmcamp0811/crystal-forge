...
pub fn PolicyEditorModal(
    ...
    rsx! {
        div {
            ...
            div {
                class: "{theme::surface::CARD_BG} border {theme::surface::CARD_BORDER} rounded-xl p-3 shadow-2xl cf-modal-panel-wide w-full max-w-5xl max-h-[78vh] flex flex-col",
                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            ...
                            input {
                                class: "w-full rounded-lg border border-gray-800 bg-gray-950/70 px-3 py-2 text-sm text-gray-100 shadow-inner shadow-black/30 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/50",
                        ...
                        div {
                            ...
                            textarea {
                                class: "w-full rounded-lg border border-gray-800 bg-gray-950/70 px-3 py-2 text-sm text-gray-100 shadow-inner shadow-black/30 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/50 resize-none",
                            ...
                            if *advanced_mode.read() {
                                ...
                                if *basic_kind.read() == BasicPolicyKind::CustomCheck {
                                    div { class: "space-y-2",
                                        ...
                                        input {
                                            class: "w-full rounded-lg border border-gray-800 bg-gray-950/70 px-3 py-2 text-xs text-gray-100 shadow-inner shadow-black/30 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/50",
                    ...
                    if *advanced_mode.read() {
                        ...
                        class: "space-y-2 flex flex-col min-h-0",
                            ...
                            div {
                                class: "rounded-lg border border-gray-800 bg-gray-950/70 overflow-hidden flex-1 min-h-0",
                                textarea {
