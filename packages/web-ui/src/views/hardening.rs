                                        ...
                                        div { class: "flex items-center gap-2 flex-wrap text-xs",
                                            if let Some(system_id) = system.system_id {
                                                Link {
                                                    ...
                                                    to: Route::SystemDetailView { id: system_id.to_string(), tab: String::new(), poam: String::new(), config_mode: String::new(), revision: String::new(), generation: String::new(), deploy_generation: String::new(), cve_target: String::new(), cve_mode: String::new() },
                                                    "{display_name(system)}"
                                                }
                                            } else {
