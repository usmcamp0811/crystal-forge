        ...
        div {
            ...
            if from_setup() {
                div {
                    ...
                    p { style: "color:#e9d5ff; font-size:12px; font-weight:700; margin:0; letter-spacing:0.03em; text-transform:uppercase;", "Setup Tour - Step 2 of 6" }
                    p { style: "color:#e9d5ff; font-size:14px; font-weight:600; margin:4px 0 0 0;", "Register a flake source" }
                    p { style: "color:#ddd6fe; font-size:13px; margin:4px 0 0 0;", "Use Add Flake to track the repo and branch your systems should deploy." }
                }
            }
