        ...
        div {
            ...
            if from_setup() {
                div {
                    ...
                    p { style: "color:#e9d5ff; font-size:12px; font-weight:700; margin:0; letter-spacing:0.03em; text-transform:uppercase;", "Setup Tour - Step 4 of 6" }
                    p { style: "color:#e9d5ff; font-size:14px; font-weight:600; margin:4px 0 0 0;", "Add a binary cache" }
                    p { style: "color:#ddd6fe; font-size:13px; margin:4px 0 0 0;", "Create a cache destination and assign environments so outputs can be distributed." }
                }
            }
                ...
                div {
                    ...
                    button {
                        class: if show_add_target_callout {
                            "px-4 py-2 rounded-lg text-sm font-medium {theme::interactive::PRIMARY_BTN} animate-pulse ring-2 ring-violet-300/70 ring-offset-2 ring-offset-slate-950"
                        } else {
