...
assert_contains "$tmp_dir/default-selection.json" '"steps":"12-systems,12a-systems-empty-state,12l-task440-config-lifecycle,12la-task440-partial-config-inventory,12ha-system-detail-cve-inventory-fallbacks,13j-task440-flake-states-panes-navigation,14d-task440-cross-surface-auth-navigation,13-flakes"'
