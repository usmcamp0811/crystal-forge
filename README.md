...
Crystal Forge supports configuration via a `config.toml` file **or** via structured environment variables. For NixOS users, a first-party NixOS module is provided to make setup seamless and reproducible.
